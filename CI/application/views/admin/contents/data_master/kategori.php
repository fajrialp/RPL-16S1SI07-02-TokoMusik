              ...
              <div class="card-body">
                ...
                <div class="centent" >
                  ...
                  <div class="card-body">
                    <table class="table table-responsive ">
                      ...
                      <?php foreach($id as $d){ ?>
                        <tr>
                          ...
                          <td><?php echo "KT". $d['id_kategori']; ?></td>
                          ...
                          <td>
                          --> <td>
                          <a class="badge badge-success" href="<?php echo base_url()."index.php/Dt_Master_Kategori/EditData/". $d['id_kategori']; ?>">-edit-</a>

                             <a  class="badge badge-danger" href="<?php echo base_url()."index.php/Dt_Master_Kategori/do_delete/". $d['id_kategori']; ?>">delete</a>
                             </td>
                          </td>
                        </tr>
                      </tbody>
                    ...
                    <form class="form-signin" action="<?php echo site_url('Dt_Master_Kategori/TambahKategori') ?>"  method="post">
