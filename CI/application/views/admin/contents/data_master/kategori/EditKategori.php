          ...
          <div class="animated fadeIn">
            ...
            <div class="card">
              <div class="card-body">
                ...
                <!-- /.row-->
     <form method="POST" action="<?php echo base_url("index.php/Dt_Master_kategori/do_update"); ?>">       
          <div class="animated fadeIn">
            <div class="row">
              <div class="col-sm-6">
                <div class="card">
                    ...
                    <div class="row">
                      <div class="col-sm-12">
                        <div class="form-group">
                          ...
                          <input class="form-control" id="name" type="text" placeholder="Masukan Id Kategori" name="id_kategori" value="<?php echo  $id_kategori; ?>" readonly/>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="row">
                      <div class="col-sm-12">
                        <div class="form-group">
                          ...
                          <input class="form-control" id="name" type="text" placeholder="Masukan Kategori Baru" name="nama_kategori" value="<?php echo $nama_kategori; ?>" >
                        </div>
                      </div>
                    </div>
