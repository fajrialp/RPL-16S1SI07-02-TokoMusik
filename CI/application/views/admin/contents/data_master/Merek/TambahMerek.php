          ...
          <div class="animated fadeIn">
            ...
            <div class="card">
              <div class="card-body">
                ...
                <!-- /.row-->
         <form method="POST" action="<?php echo base_url("index.php/Dt_Master_Merek/do_insert"); ?>">       
          <div class="animated fadeIn">
            <div class="row">
              <div class="col-sm-6">
                <div class="card">
                    ...
                    <div class="row">
                      <div class="col-sm-12">
                        <div class="form-group">
                          ...
                          <input class="form-control" id="name" type="text" placeholder="Masukan Merk Baru" name="nama_merek">
                        </div>
                      </div>
                    </div>
