          ...
          <div class="animated fadeIn">
            ...
            <div class="card">
              <div class="card-body">
                ...
                <!-- /.row-->
     <form method="POST" action="<?php echo base_url("index.php/Dt_Master_Merek/do_update"); ?>">       
          <div class="animated fadeIn">
            <div class="row">
              <div class="col-sm-6">
                <div class="card">
                  <div class="card-header">
                    <strong>Tambah Merk</strong>
                    ...
                    <div class="row">
                      <div class="col-sm-12">
                        <div class="form-group">
                          ...
                          <input class="form-control" id="name" type="text" placeholder="Masukan Id Merk" name="id_merek" value="<?php echo $id_merek; ?>" readonly/>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="row">
                      <div class="col-sm-12">
                        <div class="form-group">
                          ...
                          <input class="form-control" id="name" type="text" placeholder="Masukan Merk Baru" name="nama_merek" value="<?php echo $nama_merek; ?>" >
                        </div>
                      </div>
                    </div>
