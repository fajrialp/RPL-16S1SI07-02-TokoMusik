			...
			<div class="banner-bottom-top">
				<div class="col-md-6 banner-bottom-left">
					<div class="bnr-one">
						...
						<div class="bnr-right"> 
							<a href="single.html"><img src="<?php echo base_url('assets/web/front/images') ?>/b-1.jpg" alt="" /></a>
						</div>
				...
				<div class="col-md-6 banner-bottom-right">
					<div class="bnr-two">
						...
						<div class="bnr-right"> 
							<a href="single.html"><img src="<?php echo base_url('assets/web/front/images') ?>/b-2.jpg" alt="" /></a>
						</div>
						<div class="clearfix"> </div>
					</div>
				</div>
