        ...
        <div class="container-fluid">
         ...
         <div class="card">
                  <div class="card-header">
                    <strong>Tambah Data Barang</strong> </div>
                  <div class="card-body">
                    <form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
                      ...
                      <div class="form-group row">
                        <label class="col-md-3 col-form-label" for="email-input">Nama Produk</label>
                        <div class="col-md-9">
                          <input class="form-control" id="nama-input" type="text" name="nama_produk" placeholder="Masukan Nama Produk">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-md-9">
                          <input class="form-control" id="" type="number" name="harga" placeholder="Harga">
                      ...
                      <?php //echo form_close(); ?>
                       <div class="form-group row">
                        ...
                        <div class="col-md-9">
                          <input class="form-control" id="" type="number" name="stok" placeholder="Stok">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-md-9">
                          <select class="form-control" id="select1" name="select1">
                            ...
                            <option  value="<?php echo $kuy+1 ?>"><?php echo $m['nama_merek']; ?></option>
                          <?php } ?>
                          </select>
                        </div>
                      </div>
                       ...
                       <div class="form-group row">
                        ...
                        <div class="col-md-9">
                          ...
                          <?php foreach ($otong as $key => $k) { ?>
                            <option  value="<?php echo $key+1 ?> "><?php echo $k['nama_kategori']; ?></option>
                          <?php } ?>
                          </select>
                        </div>
                      </div>
                  ...
                  <div class="card-footer">
                    <button class="btn btn-sm btn-primary" type="submit" value="upload">
