            ...
            <div class="card">
              <div class="card-body">
                ...
                <div class="centent" >
                    ...
                    <i class="fa fa-align-justify"></i> Data Barang</div>
                  <div class="card-body">
                    <table class="table table-responsive-sm table-bordered">
                      <thead>
                        <tr>
                          <th><center>Id Produk</center></th>
                          <th><center>Nama_produk</center></th>
                      ...
                      <?php foreach($data as $d){ ?>
                        <tr>
                          ...
                          <td><center> <?php echo "PR" .$d['id']; ?></center></td>
                          <td><center><?php echo $d['nama_produk']; ?></center></td>
                          <td><center><?php echo 'Rp '. $d['harga']; ?></center></td>
                          <td ><center><?php echo $d['stok']; ?></center></td>
                          <td ><center><img src="<?php echo base_url('gambar/'.$d['gambar']) ?>" widht="100%" height="80px" alt="" /></center></td>
                          <td> <?php echo $d['nama_merek']; ?></td>
        
                           <td><center><?php echo $d['nama_kategori']; ?></center></td>
                           <td>
                          <a class="badge badge-success" href="<?php echo base_url()."index.php/Dt_Master_Barang/EditData/". $d['id']; ?>"><center>edit</center></a>

                             <a  class="badge badge-danger" href="<?php echo base_url()."index.php/Dt_Master_Barang/do_delete/". $d['id']; ?>"><center>delete</center></a>
                             </td>
                          </td>
                        </tr>
                      </tbody>
                    ...
                    <form class="form-signin" action="<?php echo site_url('Dt_Master_Barang/TambahBarang') ?>"  method="post">
                      <button class="btn btn-primary px-4" type="submit">Tambah</button>
