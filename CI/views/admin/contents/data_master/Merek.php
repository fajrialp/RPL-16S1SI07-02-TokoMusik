            ...
            <div class="card">
              <div class="card-body">
                ...
                <div class="centent" >
                    ...
                    <i class="fa fa-align-justify"></i> Data Merk</div>
                  <div class="card-body">
                    <table class="table table-responsive ">
                      ...
                      <?php foreach($id as $d){ ?>
                        <tr>
                          ...
                          <td>
                          --> <td>
                          <a class="badge badge-success" href="<?php echo base_url()."index.php/Dt_Master_Merek/EditData/". $d['id_merek']; ?>">edit</a>

                             <a  class="badge badge-danger" href="<?php echo base_url()."index.php/Dt_Master_Merek/do_delete/". $d['id_merek']; ?>">delete</a>
                             </td>
                          </td>
                        </tr>
                      </tbody>
                    ...
                    <form class="form-signin" action="<?php echo site_url('Dt_Master_Merek/TambahMerk') ?>"  method="post">
