            ...
            <div class="card">
              <div class="card-body">
                ...
                <div class="centent" >
                    ...
                    <i class="fa fa-align-justify"></i> Data Penjualan</div>
                  <div class="card-body">
                    <table class="table table-responsive-sm table-bordered">
                      <thead>
                        <tr>
                          <th><center>id_Penjualan</center></th>
                      ...
                      <?php foreach($penjualan as $p){ ?>
                        <tr>
                          ...
                          <td><center><?php echo $p['id_produk']; ?></center></td>
                          <td><center><?php echo $p['qty']; ?></center></td>
                          <td ><center><?php echo $p['id_pelanggan']; ?></center></td>
                          ...
                          --> <td>
                             ...
                             <a  class="badge badge-danger" href="<?php echo base_url()."index.php/Penjualan/". $p['id']; ?>"><center>delete</center></a>
                             </td>
                          </td>
                        </tr>
                      </tbody>
