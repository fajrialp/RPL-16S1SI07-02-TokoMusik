      ...
      <div class="row justify-content-center">
        <div class="col-md-6">
          <div class="card mx-4">
            <div class="card-body p-4">
              ...
              <form method="POST" action="<?php echo base_url("index.php/crud/do_insert"); ?>">
               <div class="input-group mb-3">
                ...
                <input class="form-control" type="text" placeholder="nama karyawan" name="nama_karyawan">
              </div>
            ...
            <hr>
            <form action="<?php echo base_url("index.php/login/index"); ?>"">
              <div class="">
               <div class="" align="center">
                    
                   <button class="btn btn-block btn-success" type="submit">Cancel</button>
               </div>
             </div>
            </form>
          </div>
